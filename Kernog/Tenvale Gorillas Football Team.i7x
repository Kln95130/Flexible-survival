...
to say GorillaWater2:
	...
	WaitLineBreak;
	if player is herm:
		say "     The brothers bury their faces against your crotch. Zach [if cunts of player is 1]alternates between giving your clit powerful suction and lapping at your [cunt width of player] pussy[else]explores each of your pussies with his tongue, filling the unused ones with his fingers[end if], while Mike [if cocks of player is 1]gobbles down your [cock of player] cock with loud noises of wet slurps, sometimes going for your balls while stroking your [cockname of player] penis with a firm hand[else]takes turn sucking down on each of your shafts, stroking the ones that he is not busy covering in saliva[end if].";
		...
		say "[if cunts of player is 1]Mike and Zach share duties. Mike applies his mouth against your clit and give it a series of powerful sucks, and licks, while Zach explores each of your [cunt length] pussy with his tongue, making sure to let no square inch untouched[else]The siblings share your [cunts of player] pussies, exploring them with their dexterous tongue. They playfully try to feel each other's tongue inside of your body, which sends you all kind of sensations through your body[end if].";
...
to say GorillaTrainingNoire:
	...
	if player consents:
		...
		say "     'Pathetic. Now, pay your bet!' Noire says.[line break]'W-Wait a minute, let's get somewh-hmmmpf!' Noire sacked the gorilla who just spoke, and the two of them crash on the grass. The horse-herm straddles the ape's face, and starts grinding her cunt against his mouth. 'Now!'[line break]'Mmmmf!' groans the gorilla, as he tries to prevent himself to be smothered by the black-furred posterior.[line break]'You!' Noire orders the nearest ape. 'Suck my cock.'[line break]'Now wait a min-'[line break]'Suck my cock or I'll take your ass when I'm done with him.'[line break]'Eek!' the gorilla says, as he gets on his knees, and begin taking care of the harm's equine cock. 'Ish thickk,' he complains as he tries to take the flared head in his mouth.[line break]'Don't care', Noire replies, grabbing his head and pushing him forward.[line break]'Ggggk!'";
